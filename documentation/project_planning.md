# 1 - Writting little by little C/ASM alongwith Arch002

## Requirements

- Only ELF 64 bits
- Encrypt a program given as parameter
- The executable must be named `woody_woodpacker`
- New program generated named "woody"
- When "woody" run have to be decrypted to be run
- Behavior should be identical to original program
- Choose an encryption algorithm (pick hard one)
- When run the program display "....WOODY....\n"
- This display indicate file is decrypted
- then run the original program behaviour
...
There is a hint about malloc how memory work in a given file
 and nm tool you read and understand how file segments is displayed
 And here you will modify segments you read untill now
 <_init> is now <null> in woody
## Proposed algorithm
...
## steps:
- Input parsing (Done)
-  Read how packers work
- Read the allowed functions